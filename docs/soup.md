...
| Ruby | simplecov | 1.3.0 | MIT | Code coverage for Ruby with a powerful configuration library and automatic merging of coverage across test suites | <https://github.com/simplecov-ruby/simplecov> | 2026-09-14 | Low | Dependency | Dependency |
...
| Ruby | bundler | 4.0.10 | MIT | Bundler manages an application's dependencies through its entire life, across many machines, systematically and repeatably | <https://bundler.io/> | 2026-09-14 | Low | Used to read Gemfile.lock files and install the gems locked in them. | Ruby's standard dependency manager, bundled with Ruby. |
