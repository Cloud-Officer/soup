...
| :---: | :--- | :---: | :---: | :--- | :--- | :---: | :---: | :--- | :--- |
| Ruby | activesupport | 8.1.2 | MIT | A toolkit of support libraries and Ruby core extensions extracted from the Rails framework | <https://rubyonrails.org> | 2026-02-25 | Low | Dependency | Dependency |
| Ruby | addressable | 2.8.8 | Apache-2.0 | Addressable is an alternative implementation to the URI implementation that is | <https://github.com/sporkmonger/addressable> | 2026-02-25 | Low | Dependency | Dependency |
...
| Ruby | bigdecimal | 4.0.1 | Ruby | This library provides arbitrary-precision decimal floating-point number class. | <https://github.com/ruby/bigdecimal> | 2023-10-26 | Low | Dependency | Dependency |
...
| Ruby | diff-lcs | 1.6.2 | MIT | Diff::LCS computes the difference between two Enumerable sequences using the | <https://github.com/halostatue/diff-lcs> | 2026-02-25 | Low | Dependency | Dependency |
| Ruby | docile | 1.4.1 | MIT | Docile treats the methods of a given ruby object as a DSL (domain specific language) within a given block | <https://ms-ati.github.io/docile/> | 2026-02-25 | Low | Dependency | Dependency |
...
| Ruby | json | 2.18.1 | Ruby | A JSON implementation as a JRuby extension. | <https://github.com/ruby/json> | 2026-02-25 | Low | Used to read package manager and cache files. | Very popular on rubygems.org |
...
| Ruby | nokogiri | 1.19.1 | MIT | Nokogiri (鋸) makes it easy and painless to work with XML and HTML from Ruby | <https://nokogiri.org> | 2024-05-15 | Low | XML parser | Most popular library |
...
| Ruby | parallel | 1.27.0 | MIT | Run any kind of code in parallel processes | <https://github.com/grosser/parallel> | 2026-02-25 | Low | Dependency | Dependency |
| Ruby | parser | 3.3.10.2 | MIT | A Ruby parser written in pure Ruby. | <https://github.com/whitequark/parser> | 2026-02-25 | Low | Dependency | Dependency |
...
| Ruby | public_suffix | 7.0.2 | MIT | PublicSuffix can parse and decompose a domain name into top level domain, domain and subdomains. | <https://simonecarletti.com/code/publicsuffix-ruby> | 2026-02-25 | Low | Dependency | Dependency |
...
| Ruby | rspec-expectations | 3.13.5 | MIT | rspec-expectations provides a simple, readable API to express expected outcomes of a code example. | <https://rspec.info> | 2026-02-25 | Low | Dependency | Dependency |
| Ruby | rspec-mocks | 3.13.7 | MIT | RSpec's 'test double' framework, with support for stubbing and mocking | <https://rspec.info> | 2026-02-25 | Low | Dependency | Dependency |
| Ruby | rspec-support | 3.13.7 | MIT | Support utilities for RSpec gems | <https://rspec.info> | 2026-02-25 | Low | Dependency | Dependency |
| Ruby | rubocop | 1.85.0 | MIT | RuboCop is a Ruby code style checking and code formatting tool. | <https://rubocop.org/> | 2023-06-12 | Low | Ruby linter | Most popular gem on rubygems |
...
| Ruby | ruby-progressbar | 1.13.0 | MIT | Ruby/ProgressBar is an extremely flexible text progress bar library for Ruby | <https://github.com/jfelchner/ruby-progressbar> | 2026-02-25 | Low | Dependency | Dependency |
...
| Ruby | semantic | 1.6.1 | MIT | Semantic Version utility class for parsing, storing, and comparing versions | <https://github.com/jlindsey/semantic> | 2026-02-25 | Low | Used to manipulate package versions. | Very popular on rubygems.org |
| Ruby | simplecov | 0.22.0 | MIT | Code coverage for Ruby with a powerful configuration library and automatic merging of coverage across test suites | <https://github.com/simplecov-ruby/simplecov> | 2026-02-25 | Low | Dependency | Dependency |
| Ruby | simplecov-html | 0.13.2 | MIT | Default HTML formatter for SimpleCov code coverage tool for ruby 2.4+ | <https://github.com/simplecov-ruby/simplecov-html> | 2026-02-25 | Low | Dependency | Dependency |
| Ruby | simplecov_json_formatter | 0.1.4 | MIT | JSON formatter for SimpleCov | <https://github.com/fede-moya/simplecov_json_formatter> | 2026-02-25 | Low | Dependency | Dependency |
...
| Ruby | tzinfo | 2.0.6 | MIT | TZInfo provides access to time zone data and allows times to be converted using time zone rules. | <https://tzinfo.github.io> | 2026-02-25 | Low | Dependency | Dependency |
| Ruby | unicode-display_width | 3.2.0 | MIT | [Unicode 17.0.0] Determines the monospace display width of a string using EastAsianWidth.txt, Unicode general category, Emoji specification, and other data. | <https://github.com/janlelis/unicode-display_width> | 2026-02-25 | Low | Dependency | Dependency |
...
| Ruby | webmock | 3.26.1 | MIT | WebMock allows stubbing HTTP requests and setting expectations on HTTP requests. | <https://github.com/bblimke/webmock> | 2026-02-25 | Low | Dependency | Dependency |
