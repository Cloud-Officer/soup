...
| :---: | :--- | :---: | :---: | :--- | :--- | :---: | :---: | :--- | :--- |
| Ruby | CFPropertyList | 3.0.5 | MIT | This is a module to read, write and manipulate both binary and XML property lists as defined by apple. | <https://github.com/ckruse/CFPropertyList> | 2022-05-10 | Low | Dependency | Dependency |
| Ruby | activesupport | 6.1.6 | MIT | A toolkit of support libraries and Ruby core extensions extracted from the Rails framework | <https://rubyonrails.org> | 2022-05-10 | Low | Dependency | Dependency |
| Ruby | addressable | 2.8.0 | Apache-2.0 | Addressable is an alternative implementation to the URI implementation that is | <https://github.com/sporkmonger/addressable> | 2022-05-10 | Low | Dependency | Dependency |
...
| Ruby | cocoapods | 1.11.3 | MIT | CocoaPods manages library dependencies for your Xcode project. | <https://github.com/CocoaPods/CocoaPods> | 2022-05-10 | Low | Used to read Podfile | Same package used by CocoaPods |
| Ruby | cocoapods-core | 1.11.3 | MIT | The CocoaPods-Core gem provides support to work with the models of CocoaPods. | <https://github.com/CocoaPods/CocoaPods> | 2022-05-10 | Low | Dependency | Dependency |
...
| Ruby | concurrent-ruby | 1.1.10 | MIT | Modern concurrency tools including agents, futures, promises, thread pools, actors, supervisors, and more. | <http://www.concurrent-ruby.com> | 2022-05-10 | Low | Dependency | Dependency |
| Ruby | escape | 0.0.4 |  | ... | <http://www.a-k-r.org/escape/> | 2022-05-10 | Low | Dependency | Dependency |
| Ruby | ethon | 0.15.0 | MIT | Very lightweight libcurl wrapper. | <https://github.com/typhoeus/ethon> | 2022-05-10 | Low | Dependency | Dependency |
| Ruby | ffi | 1.15.5 | BSD-3-Clause | Ruby FFI library | <https://github.com/ffi/ffi/wiki> | 2022-05-10 | Low | Dependency | Dependency |
...
| Ruby | httparty | 0.20.0 | MIT | Makes http fun! Also, makes consuming restful web services dead easy. | <https://github.com/jnunemaker/httparty> | 2022-05-10 | Low | Makes http fun! Also, makes consuming restful web services dead easy. | Very popular on rubygems.org |
...
| Ruby | i18n | 1.10.0 | MIT | New wave Internationalization support for Ruby. | <https://github.com/ruby-i18n/i18n> | 2022-05-10 | Low | Dependency | Dependency |
...
| Ruby | json | 2.6.1 | Ruby | A JSON implementation as a JRuby extension. | <http://flori.github.io/json/> | 2022-05-10 | Low | Used to read package manager and cache files. | Very popular on rubygems.org |
| Ruby | mime-types | 3.4.1 | MIT | The mime-types library provides a library and registry for information about | <https://github.com/mime-types/ruby-mime-types/> | 2022-05-10 | Low | Dependency | Dependency |
| Ruby | mime-types-data | 3.2022.0105 | MIT | mime-types-data provides a registry for information about MIME media type | <https://github.com/mime-types/mime-types-data/> | 2022-05-10 | Low | Dependency | Dependency |
| Ruby | minitest | 5.15.0 | MIT | minitest provides a complete suite of testing facilities supporting | <https://github.com/seattlerb/minitest> | 2022-05-10 | Low | Dependency | Dependency |
...
| Ruby | optparse | 0.2.0 | Ruby | OptionParser is a class for command-line option analysis. | <https://github.com/ruby/optparse> | 2022-05-10 | Low | Used to parse command line arguments. | Very popular on rubygems.org |
...
| Ruby | parser | 3.1.2.0 | MIT | A Ruby parser written in pure Ruby. | <https://github.com/whitequark/parser> | 2022-05-10 | Low | Dependency | Dependency |
...
| Ruby | regexp_parser | 2.3.1 | MIT | A library for tokenizing, lexing, and parsing Ruby regular expressions. | <https://github.com/ammar/regexp_parser> | 2022-05-10 | Low | Dependency | Dependency |
| Ruby | rexml | 3.2.5 | BSD-2-Clause | An XML toolkit for Ruby | <https://github.com/ruby/rexml> | 2022-05-10 | Low | Dependency | Dependency |
| Ruby | rubocop | 1.29.0 | MIT |     RuboCop is a Ruby code style checking and code formatting tool. | <https://rubocop.org/> | 2022-05-10 | Low | Used to lint ruby code in project. | Very popular on rubygems.org |
| Ruby | rubocop-ast | 1.17.0 | MIT |     RuboCop's Node and NodePattern classes. | <https://www.rubocop.org/> | 2022-05-10 | Low | Dependency | Dependency |
...
| Ruby | ruby-progressbar | 1.11.0 | MIT | Ruby/ProgressBar is an extremely flexible text progress bar library for Ruby | <https://github.com/jfelchner/ruby-progressbar> | 2022-05-10 | Low | Dependency | Dependency |
...
| Ruby | tins | 1.31.1 | MIT | All the stuff that isn't good/big enough for a real library. | <https://github.com/flori/tins> | 2022-05-10 | Low | Dependency | Dependency |
...
| Ruby | tzinfo | 2.0.4 | MIT | TZInfo provides access to time zone data and allows times to be converted using time zone rules. | <https://tzinfo.github.io> | 2022-05-10 | Low | Dependency | Dependency |
| Ruby | unicode-display_width | 2.1.0 | MIT | [Unicode 14.0.0] Determines the monospace display width of a string using EastAsianWidth.txt, Unicode general category, and other data. | <https://github.com/janlelis/unicode-display_width> | 2022-05-10 | Low | Dependency | Dependency |
| Ruby | xcodeproj | 1.21.0 | MIT | Xcodeproj lets you create and modify Xcode projects from Ruby | <https://github.com/cocoapods/xcodeproj> | 2022-05-10 | Low | Dependency | Dependency |
| Ruby | zeitwerk | 2.5.4 | MIT |     Zeitwerk implements constant autoloading with Ruby semantics | <https://github.com/fxn/zeitwerk> | 2022-05-10 | Low | Dependency | Dependency |
